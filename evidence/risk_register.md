...
| --- | --- | --- | --- | --- | --- | --- | --- |
| R-01 | Audio too loud for a sound-sensitive child (sudden peak, route change, user error) | 3 | 5 | 15 | Deterministic ceiling + limiter + fade-in + slew limit (REQ-SAF-01/03/07); 100% branch-covered tests; route-specific device tests | Architects / QA | Mitigated: AS-01 to AS-08 pass; DEF-001 found and fixed; device-route tests OUTSTANDING |
...
| R-03 | App or AI implies a cure or reduction in core severity | 3 | 5 | 15 | Claims register, banned-term checker on content and AI output, refusal templates, zero-tolerance eval | Evaluators | Mitigated: 0 cure claims across 125 eval outputs; compliance checker in CI |
...
| R-15 | Web-audio latency on low-end Android over 50 ms | 3 | 2 | 6 | Pre-scheduled synthesis; latency hint "interactive"; spike measured (see tests/audio_safety_report.md) | Developers | 15 ms scheduling in headless Chromium; real-device measurement OUTSTANDING |
